...
export function Header() {
  ...
  if (!mounted) {
    return (
      <Flex as="header" position="sticky" top={0} zIndex={10} bg="blackAlpha.800" backdropFilter="blur(16px)" borderBottom="1px solid" borderColor="whiteAlpha.100" justify="center" py={5} boxShadow="sm">
